...
schema_db <- if (length(params) < 2) "socialstyrelsen" else params[2]      # sparar till schema "socialstyrelsen" om det inte finns ett andra argument medskickat
tabell_db <- if (length(params) < 3) "ek_bistand_sek" else params[3]       # sparar till schema "ek_bistand_hushall" om det inte finns ett tredje argument medskickat
