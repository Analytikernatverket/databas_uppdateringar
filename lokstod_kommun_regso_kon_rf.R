...
source("https://raw.githubusercontent.com/Analytikernatverket/hamta_data/main/lokstod_kommun_regso_kon_rf.R")
...
tabell_db <- if (length(script_args) < 3) "lokstod_regso" else script_args[3]        # sparar till schema "lokstod_regso" om det inte finns ett tredje argument medskickat

lokstod_df <- hamta_lokstod_kommun_regso_kon_rf()
